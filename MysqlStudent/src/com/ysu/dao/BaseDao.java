...
public class BaseDao<T> {
	//单例模式，即一个对象只能有一个实例，不能有多个
	private DbUtil dbUtil = DbUtil.getInstance();//创建对象
	//public Connection connection = dbUtil.getConnection();//创建连接
	 ...
	 * 获取实体对应的数据库表名
	 */
	private String getTableName() {//获取表名
